...
<div class="container-fluid">
    ...
    <div class = "row" >
        ...
        <div class = "col-xs-3 col-sm-3 col-md-3 col-lg-3 col-md-offset-1" style = "background-color: #dedef8;
            ...
            <form action='includes/unverified.php ' method='post' class="form-signin" role="form">
                ...
                <input name="unvemail" type="email" id="inputEmail" class="form-control" placeholder="Email address" required autofocus style="display: inline-block; width: 50%">


                <div align="center">
                    <button class="btn btn-primary btn-block btn-signin" type="submit" style="width: 60%;margin-left: 8%">sent mail</button>
